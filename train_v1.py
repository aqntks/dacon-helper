...
def setup():
    ...
    register_coco_instances('dacon_train', {}, 'train_annotations.json', dataDir)
    register_coco_instances('dacon_val', {}, 'train_annotations.json', dataDir)
    metadata = MetadataCatalog.get('dacon_train')
    train_ds = DatasetCatalog.get('dacon_train')

    cfg.merge_from_file(model_zoo.get_config_file(model_name))
    cfg.DATASETS.TRAIN = ("dacon_train",)
    cfg.DATASETS.TEST = ()
...
def main():
    ...
    cfg.OUTPUT_DIR = "./weights/weight1"
